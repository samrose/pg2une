defmodule Pg2une.Tunable do
    ...
    case workload do
      :oltp ->
        [
          ...
          %Anytune.Dimension{name: "work_mem_mb", type: :integer,
            low: 4, high: 64, prior: "log-uniform"},
      ...
      :olap ->
        [
          ...
          %Anytune.Dimension{name: "work_mem_mb", type: :integer,
            low: 128, high: 512, prior: "log-uniform"},
          %Anytune.Dimension{name: "maintenance_work_mem_mb", type: :integer,
            low: 256, high: 2048},
          %Anytune.Dimension{name: "random_page_cost", type: :float,
            low: 1.1, high: 4.0},
      ...
      _mixed ->
        [
          ...
          %Anytune.Dimension{name: "effective_cache_size_mb", type: :integer,
            low: div(total_ram * 60, 100), high: div(total_ram * 75, 100)},
          %Anytune.Dimension{name: "work_mem_mb", type: :integer,
            low: 32, high: 128, prior: "log-uniform"},
          %Anytune.Dimension{name: "maintenance_work_mem_mb", type: :integer,
            low: 128, high: 1024},
          %Anytune.Dimension{name: "random_page_cost", type: :float,
            low: 1.1, high: 3.0},
  ...
  defp index_dimensions do
    case Process.whereis(Pg2une.IndexAnalyzer) do
      nil -> []
      _pid -> Pg2une.IndexAnalyzer.dimensions()
    end
  end

  defp hint_dimensions do
    case Process.whereis(Pg2une.HintAnalyzer) do
      nil -> []
      _pid -> Pg2une.HintAnalyzer.dimensions()
    end
  end
end
