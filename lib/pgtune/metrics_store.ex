defmodule Pgtune.MetricsStore do
  @moduledoc """
  Persists metrics to pgtune's own PostgreSQL via Ecto.
  ...
  import Ecto.Query
  alias Pgtune.Repo
  alias Pgtune.Schemas.{SystemSnapshot, WorkloadSnapshot, OptimizerObservation, OptimizationRun}
